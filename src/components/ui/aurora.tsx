...
export function AuroraBackground({
  ...
  return (
    <div className={cn('relative min-h-screen bg-background text-foreground', className)} {...props}>
      <div
      ...
      >
        <div
          className={cn(
            'absolute -inset-[10px] opacity-50 blur-[10px] invert will-change-transform',
