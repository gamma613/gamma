...
export function Header() {
  ...
  return (
    <header
      className="fixed inset-x-0 bottom-0 z-30 bg-background/30 h-[var(--header-h)] supports-[backdrop-filter]:backdrop-blur-md"
      style={{ height: '100px' }}
    >
      <div className="mx-auto max-w-md sm:max-w-3xl px-3">
